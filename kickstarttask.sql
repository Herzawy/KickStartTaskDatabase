...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2022 at 09:54 PM
...
INSERT INTO `countries` (`id`, `sort`, `country_name`, `phoneCode`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `entries` (`id`, `message`, `sentiment`, `country_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'It is very hot in, Cairo', 'Neutral', 185, NULL, '2022-08-06 11:33:12', '2022-08-06 11:33:12'),
(2, 'There is new project started in, Nairobi', 'Positive', 88, NULL, '2022-08-06 11:33:12', '2022-08-06 11:33:12'),
(3, 'Dubai EXPO 2020 will create a new image for the middle, Dubai', 'Positive', 41, NULL, '2022-08-06 11:33:12', '2022-08-06 11:33:12'),
(4, 'I hate black people, there are so many of them in, New York', 'Negative', 64, NULL, '2022-08-06 11:33:12', '2022-08-06 11:33:12'),
(5, 'Do you COVID Vaccine, Jeddah, is good?', 'Negative', 45, NULL, '2022-08-06 11:33:12', '2022-08-06 11:33:12'),
(6, 'nice Weather Cairo', 'Positive', 99, NULL, '2022-08-06 11:35:02', '2022-08-06 11:35:02');
...
(5, '2022_08_06_130355_create_countries_table', 2),
(6, '2022_08_06_120418_create_entries_table', 3);
...
ALTER TABLE `entries`
  ADD PRIMARY KEY (`id`),
  ADD KEY `entries_country_id_foreign` (`country_id`);
...
--
ALTER TABLE `entries`
  ADD CONSTRAINT `entries_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE;
COMMIT;
